...
describe("Oracle Client", function () {
  ...
  test("setActiveRequestByTransaction", function (done) {
    const transactionHash =
      "0x91720719f4768e10849ebb5f41690488f7060e10534c5c4f15e69b7dc494502a";
    const chainId = 1;
    const id = client.setActiveRequestByTransaction({
      transactionHash,
      chainId,
    });
  ...
  test("setActiveRequestByTransaction failure", function (done) {
    const transactionHash =
      "0x91720719f4768e10849ebb5f41690488f7060e10534c5c4f15e69b7dc494502a";
    const chainId = 1;
    const eventIndex = 1;
