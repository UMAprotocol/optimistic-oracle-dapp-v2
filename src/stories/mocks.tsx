...
import type { Assertion, Assertions, Request } from "@libs/oracle2";
...
export const defaultMockAssertion = (
  ...
  return {
    ...
    oracleAddress: "0xfb55F43fB9F48F63f9269DB7Dde3BbBe1ebDC0dE",
...
type VersionAndChain = {
  version: 1 | 2 | 3;
  chainId: number;
  requests?: OptimisticPriceRequests;
...
export function makeRequestHandlerForOraclesAndChains(
  ...
  return makeQueryNamesForAllOracles().map((queryName) =>
    graphql.query(queryName, (_req, res, ctx) => {
      ...
      const optimisticPriceRequests: OptimisticPriceRequests = [];
